...
class VectorIndividual(evo.Individual):
    ...
    def __init__(self, genotype, fitness=None, data=None):
        ...
        :param genotype: the genotype, i.e. an iterable of
            ``True``\ /\ ``False`` values that will form the individual.
        """
...
class RandomRealVectorInitializer(evo.IndividualInitializer):
    ...
    def __init__(self, length, **kwargs):
        ...
        self.distribution = evo.utils.random.Distribution.uniform(0, 1)
